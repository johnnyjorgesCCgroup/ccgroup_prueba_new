...
var Tab = React9.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime8.jsxs)(React9.Fragment, {
      children: [icon, label]
...
var Tabs = React12.forwardRef(function Tabs2(inProps, ref) {
  ...
  const children = React12.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React12.cloneElement(child, _extends({
...
//# sourceMappingURL=chunk-F7UE242U.js.map
